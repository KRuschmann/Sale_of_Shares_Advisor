...
**Please note:** <br>
You can find the plain code in the [Code_SIA_Final.py file](https://github.com/KRuschmann/Stock_Investing_Advisor/blob/master/Code_SIA_Final.py). The Code_SIA_Final.ipynb file includes the code with descriptions and further intermediate results.
